...
// Daca $id este false inseamna ca nu exista utilizatorul si vom redirecta catre formular login 
    ...
    if (!$id) {
    	...
    	echo "<br>";
    	echo "<a href='tema4_formular_login.php'>Login</a>";
    	exit;
    }
...
// sau catre catre tema4_orar_plecari.php
	if ($valid == 0) {
		...
		echo "<a href='tema4_formular_login.php'>Login</a>";
		echo "<br>";
		echo "<a href='tema4_orar_plecari.php'>Orar plecari</a>";
		exit;
	}
	...
	if ($id == 1) {
		header("location: tema4_orar_plecari_admin.php");
	} else {
		header("location: tema4_orar_plecari_utilizatori.php");
	}
}