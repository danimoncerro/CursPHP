...
<input size="43" type="text" name="nume" >
</td>
<td width="30%"><p>
</p>
</td>
...
<?php
if(isset($_COOKIE['prenumele'])){
  echo "<input size='43' type='text' name='prenume' value='$_COOKIE[prenumele]' >";
} else {
...
<td style="text-align:center">
<input size="43" type="text" name="email" >
</td>
...
<td style="text-align:center">
			<input type="radio" name="sexul" value="male" checked>Male
			<input type="radio" name="sexul" value="female">Female
</td>
<td width="30%"><p>
</p>
</td>
