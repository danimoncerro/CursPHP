		...
		<div class="row">
			<div class="col-md-12">
				<ul class="nav nav-tabs">
				  ...
				  <li><a data-toggle="tab" href="#menu2">Tabel cu zmeura</a></li>
				  <li><a data-toggle="tab" href="#zmeura-carousel">Zmeura carousel</a></li>
				</ul>

			<div class="tab-content">
			  <div id="home" class="tab-pane fade in active">
			    <h3>Video zmeura</h3>
			    <p><iframe width="420" height="315" src="https://www.youtube.com/embed/IRX5oP4h354" frameborder="0" allowfullscreen></iframe></p>
			  </div>
			  ...
			  <div id="menu2" class="tab-pane fade">
				...
				<tr>
				  ...
				  <div id="zmeura-carousel" class="tab-pane fade">
